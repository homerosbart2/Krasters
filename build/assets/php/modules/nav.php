        ...
        <nav>
            <ul class="main-nav">
                ...
                <span class="options-division">
                    ...
                    <li><a href="" class="nav-option"><span class="option-icon"><i class='fa fa-shopping-cart'></i></span><span class="option-label">Carrito</span><span class="counter">2</span></a></li>
